...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-02-2023 a las 12:58:02
...
CREATE TABLE `reservas` (
  ...
  `fecha` date NOT NULL,
  `email_r` varchar(40) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
...
ALTER TABLE `reservas`
  ADD PRIMARY KEY (`codRes`) USING BTREE,
  ADD KEY `fk_rc` (`email_r`);
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_rc` FOREIGN KEY (`email_r`) REFERENCES `clientes` (`Email`);
COMMIT;
